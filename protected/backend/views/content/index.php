...
<div id="breadcrumbs">
    <ul class="breadcrumb">
        ...
        <li style="float: right; margin-top: -5px;">
            <a class="btn btn-primary btn-sm" href="<?php if (isset($program)){ echo Yii::app()->request->baseUrl . "/admin.php/content/create/" . $program->id; } else{ echo Yii::app()->request->baseUrl . "/admin.php/content/create"; }?>"><i class="fa fa-add"></i> Add Page</a>
        </li>
    </ul>
</div>
<!-- END Breadcrumb -->
