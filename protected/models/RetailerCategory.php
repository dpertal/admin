...
class RetailerCategory extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('name', 'required'),
			array('parent_id, external_id, active, created_by, modified_by', 'numerical', 'integerOnly'=>true),
			...
			array('id, name, parent_id, keywords, external_id, image, active, created, created_by, modified, modified_by', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'retailerCategoryAssociations' => array(self::HAS_MANY, 'RetailerCategoryAssociation', 'category_id'),
		);
	}
