...
<div id="breadcrumbs">
    <ul class="breadcrumb">
        ...
        <li style="float: right; margin-top: -5px;">
            <a class="btn btn-primary btn-sm" href="<?php if (isset($program)){ echo Yii::app()->request->baseUrl . "/index.php/faq/create/" . $program->id;} else { echo Yii::app()->request->baseUrl . "/index.php/faq/create/"; } ?>"><i class="fa fa-add"></i> Add FAQ</a>
        </li>
    </ul>
</div>
<!-- END Breadcrumb -->
