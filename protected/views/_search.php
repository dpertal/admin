    ...
    <div class="search_box">
        ...
        <span><i>By Name:</i>
            ...
            $this->widget('zii.widgets.jui.CJuiAutoComplete', array(
                ...
                'source' => '/index.php/quote/getNames', // <- path to controller which returns dynamic data
                'options' => array(
        ...
        if ($this->type == 'quote') {
            ...
            <span> <i>Assigned Staff:</i>
                ...
                $this->widget('zii.widgets.jui.CJuiAutoComplete', array(
                    ...
                    'source' => '/index.php/quote/getAssignedStaff', // <- path to controller which returns dynamic data
                    'options' => array(
                        'minLength' => '1', // min chars to start search
                        'select' => 'js:function(event, ui) { console.log(ui.item.id +":"+ui.item.value); }'
                    ),
        ...
        <?php } if (isset($this->invoice) && $this->invoice == 'Yes') { ?>
            ...
            <span> <i>By Street:</i>
                ...
                $this->widget('zii.widgets.jui.CJuiAutoComplete', array(
                    ...
                    'source' => '/index.php/quote/streetAdd', // <- path to controller which returns dynamic data
                    'options' => array(
                        'minLength' => '1', // min chars to start search
                        'select' => 'js:function(event, ui) { console.log(ui.item.id +":"+ui.item.value); }'
                    ),
            ...
            <span> <i>By Suburb:</i>
                ...
                $this->widget('zii.widgets.jui.CJuiAutoComplete', array(
                    ...
                    'source' => '/index.php/quote/suburb', // <- path to controller which returns dynamic data
                    'options' => array(
                        'minLength' => '1', // min chars to start search
                        'select' => 'js:function(event, ui) { console.log(ui.item.id +":"+ui.item.value); }'
                    ),
