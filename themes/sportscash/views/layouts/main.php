...
<html>
    <head>
        ...
        <title>SportsCash Home</title>
        <link rel="stylesheet" type="text/css" href="<?= $BASE_URL ?>/css/colorbox.css">
        <link rel="stylesheet" type="text/css" href="<?= $BASE_URL ?>/skin/sportscash/css/components.css">
        <link rel="stylesheet" type="text/css" href="<?= $BASE_URL ?>/skin/sportscash/css/style.css">
        <link rel="stylesheet" type="text/css" href="<?= $BASE_URL ?>/skin/sportscash/css/shared.css">
        <link rel="stylesheet" type="text/css" href="<?= $BASE_URL ?>/skin/sportscash/css/tabs.css">
        <link rel="stylesheet" type="text/css" href="<?= $BASE_URL ?>/skin/sportscash/css/home.css">
        <link rel="stylesheet" type="text/css" href="<?= $BASE_URL ?>/skin/sportscash/css/fonts.css">	

        <script src="http://ajax.googleapis.com/ajax/libs/jquery/1.8.3/jquery.min.js"></script>
        <script src="<?= $BASE_URL ?>/skin/sportscash/js/main.js"></script>
        <script src="<?= $BASE_URL ?>/skin/sportscash/js/retailer_info.js"></script>
        <script src="<?= $BASE_URL ?>/skin/sportscash/js/jquery.nicescroll.js"></script>
    </head>
    <body>
            ...
            <div class="header">
                <div class="header-detail">
                    <div class="collapse-menu-icon">
                        <a href="#"><img src="<?= $BASE_URL ?>/skin/sportscash/images/ic_menu_white.png" alt="" border="0" /></a>
                    </div>
                    <div class="logo"><a href="/"><img src="<?= $BASE_URL ?>/skin/sportscash/images/logo.png" alt="" /></a></div>
            ...
            <div class="search-bar">
                <div class="search-bar-detail">
                    ...
                    <form name="search_frm" method="post" action="<?= $BASE_URL ?>/index.php/site/search">
                        ...
                        ?>
                        <input type="image" src="<?= $BASE_URL ?>/skin/sportscash/images/search-ico.png" />
                    </form>
                    ...
                    if (Yii::app()->user->isGuest)
                        ...
                        echo CHtml::link('Log out', array('Login/Logout'), array('class' => 'btn blue hidden-small-phone'));
                    ?>
                    <a href="https://SportsCash.mycardplace.com/cholder" class="btn blue">Activate Your Card</a>
                </div>
            </div><!-- END SEARCH BAR -->
                    ...
                    <ul>
                        <?php foreach (Retailers::getListRetailers() as $retailer) : ?>
                            <li onclick="showRetailerOverlay('<?= $BASE_URL ?>/index.php/site/GetIDRetailers/<?= $retailer->id ?>');">
                                <?php if ($retailer->logo_url != '') { ?> <img src="<?= $retailer->logo_url ?>" /> <?php } else { ?><img src="<?= $BASE_URL ?>/skin/sportscash/images/ic_online_blue.png" alt="" /> <?php } ?>
            ...
            <div class="footer">
                <div class="footer-detail">
                    ...
                    <div class="footer-right">
                        <p>Powered by</p>
                        <p><img src="<?= $BASE_URL ?>/skin/sportscash/images/btm-logo-img.png" alt="" /></p>
                        <p>&copy; Sports Cash 2014</p>
                    </div>
                    <div class="clear"></div>
                </div>
            </div><!-- END FOOTER -->
