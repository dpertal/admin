            ...
            <table border="0" cellpadding="0" cellspacing="0" class="wrapper">
                <tr>
                    <td>
						...
						<a style="color:#ab1e25; text-decoration:none" href="<?= $domainURL ?>/Join/Confirmation?token=<?= $emailToken ?>" target="_blank"><?= $domainURL ?>/Join/Confirmation?token=<?= $emailToken ?></a>
